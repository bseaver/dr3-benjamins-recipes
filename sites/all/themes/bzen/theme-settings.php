 ...
 */
function bzen_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['bzen_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('bzen sample setting'),
  '#default_value' => theme_get_setting('bzen_example'),
